...
<body>
	<div class="container">
			...
			<div class="task">
				...
				<c:if test="${not empty tehtavat}">
					<c:forEach var="tehtava" items="${tehtavat}" varStatus="counter">
						<p>
							<c:out
								value="${counter.count}. ${tehtava.id}, ${tehtava.kuvaus}, ${tehtava.lisatiedot}, ${tehtava.status}, ${tehtava.pvm}, ${tehtava.aika}" />
						</p>
					</c:forEach>
				</c:if>
			</div>
		...
		<div id="addtaskform" hidden="">
			...
			<form:form modelAttribute="tehtava" method="post">
				<fieldset>
					<div class="form-group">
						<form:input path="task" type="text" class="form-control inline" placeholder="Lisää tehtävä" />
					</div>
					<div class="form-group">
						<form:input path="info" type="text" class="form-control inline" placeholder="Lisätiedot" />
